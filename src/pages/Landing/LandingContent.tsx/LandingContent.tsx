...
const provide3 = [
  {
    ...
    description:
      "Worlds most advanced Diode Laser. Your treatment experience will be relaxing & smooth.",
  },
  {
    img: p02,
...
function LandingContent() {
  ...
  useEffect(() => {
    const getList = async () => {
      try {
        const resBranch = await axios.get(API_ENDPOINTS.BRANCH.LIST);
        const resDentist = await axios.get(API_ENDPOINTS.USERS.LIST_DENTIST);
        const resStaff = await axios.get(API_ENDPOINTS.USERS.LIST_STAFF);
        setBranchs(resBranch.data.data.list);
        setDentist(resDentist.data.data.list);
        setStaff(resStaff.data.data.list);
      } catch (error) {
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <TextBox>
            <BigTextWhite>How to get our service?</BigTextWhite>
            <SmallTextWhite>Just follow these simple steps</SmallTextWhite>
          </TextBox>
          <Box
            sx={{
              display: "flex",
          ...
          >
            ...
            <TextBox2 onClick={handleShowStaffList}>
              <GroupIcon
                sx={{
                  fontSize: "2.5rem",
                  color: (theme) => theme.palette.primary.light,
            ...
            <TextBox2 onClick={handleShowDentistList}>
              <GroupIcon
                sx={{
                  fontSize: "2.5rem",
                  color: (theme) => theme.palette.primary.light,
      ...
      {showBranchPhones && (
        <PopUp>
          <PopUpContent>
            ...
            >
              <Logo />
              <Close onClick={handleClosePopup}>&times;</Close>
            </Box>
            <Box
              sx={{
                overflow: "auto",
      ...
      <Container sx={{ pt: 10 }}>
        ...
        >
          <BigTextBlack>What Makes Us More</BigTextBlack>
          <SpecialText>
            KEY <YellowText>FEATURE</YellowText>
          </SpecialText>
        </Box>
        <Box
          sx={{
      ...
      >
        <SmallTextWhite sx={{ fontSize: 25 }}>
          Let Us Brighten <WhiteTextSpan>Your Smile!</WhiteTextSpan>
        </SmallTextWhite>
        <Typography
          sx={{
            pt: 2,
      ...
      <Container sx={{ pt: 10 }}>
        ...
        >
          <SpecialText>
            WHO <YellowText>WE ARE</YellowText>
          </SpecialText>
          <BigTextBlack>Our Glorious</BigTextBlack>
        </Box>
        <Box
          sx={{
            display: "flex",
          ...
          >
            ...
            >
              ...
              >
                ...
                York. The journey of this institution started in 1990 under the
                hands of Dr. Jonathon Doe, Gold Medalist of Harvard University.
                Dentics dental center has been leading the way in dental
                treatment in USA for more than 30 years in keeping with the
      ...
      >
        <Container sx={{ pt: 5, pb: 5 }}>
          ...
          >
            <BigTextBlack>Meet Some of Our</BigTextBlack>
            <SpecialText>
              OUR FOUNDING <YellowText>DOCTORS</YellowText>
            </SpecialText>
          </Box>
          <Box
            sx={{
